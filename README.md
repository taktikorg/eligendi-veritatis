...
> If there are items missing from this section, feel free to [create an issue](https://github.com/taktikorg/eligendi-veritatis/issues/new).
...
```shell
git clone https://github.com/taktikorg/eligendi-veritatis.git
